...
This **pink variant** is inspired by the visual style of Fallout 3.  
...
Available color schemes: **classic green**, **yellow**, and **mint** versions.  
The default calendar icon (with number 7) in "Date & Time" settings looks organic only in the mint version.

## 🖼️ Screenshots

![Fallout Pip-Boy 1P Theme Demo](screenshot.gif)
