# Reverse mint Fallout Pip-Boy theme for Innioasis Y1 (Y2)
...
This **mint green variant** is inspired by the visual style of Fallout 3.  
...
![Fallout Pip-Boy 1RM main menu](screenshot-0.png)
![Fallout Pip-Boy 1RM settings](screenshot-1.png)
