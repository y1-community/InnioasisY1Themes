# Reverse green Fallout Pip-Boy theme for Innioasis Y1 (Y2)
...
This **reverse green variant** is inspired by the visual style of Fallout 3.  
...
Available color schemes: **reverse yellow**, **reverse pink**, and **reverse mint** versions.  
The default calendar icon (with number 7) in "Date & Time" settings looks organic only in the mint version.

## 🖼️ Screenshots

![Fallout Pip-Boy 1RG main menu](screenshot-0.png)
![Fallout Pip-Boy 1RG settings](screenshot-1.png)
