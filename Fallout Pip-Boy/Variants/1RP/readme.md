# Reverse pink Fallout Pip-Boy theme for Innioasis Y1 (Y2)
...
This **reverse pink variant** is inspired by the visual style of Fallout 3.  
...
Available color schemes: **reverse yellow**, **reverse green**, and **reverse mint** versions.  
The default calendar icon (with number 7) in "Date & Time" settings looks organic only in the mint version.

## 🖼️ Screenshots

![Fallout Pip-Boy 1RP main menu](screenshot-0.png)
![Fallout Pip-Boy 1RP settings](screenshot-1.png)
