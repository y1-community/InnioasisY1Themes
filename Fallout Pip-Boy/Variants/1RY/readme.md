# Reverse yellow Fallout Pip-Boy theme for Innioasis Y1 (Y2)

This repository contains a series of themes for the Innioasis Y1 (Y2) music player, styled after the **Pip-Boy** screen from the Fallout game series.

## 🎨 Theme Description

This **reverse yellow variant** is inspired by the visual style of Fallout 3.  
The interface uses original game icons along with hand-drawn elements adapted for Y1 (Y2) firmware limitations.  
The theme is maximally detailed based on all available information from official resources and the r/innioasis community.

Available color schemes: **reverse green**, **reverse pink**, and **reverse mint** versions.  
The default calendar icon (with number 7) in "Date & Time" settings looks organic only in the mint version.

## 🖼️ Screenshots

![Fallout Pip-Boy 1RY main menu](screenshot-0.png)
![Fallout Pip-Boy 1RY settings](screenshot-1.png)
...
- [All Innioasis Y1 & Y2 themes](https://themes.innioasis.app)
...
**Reverse Fallout Pip-Boy тема** для плеера Innioasis Y1 (Y2) (жёлтая, розовая, зелёная, мятная). 🎮
