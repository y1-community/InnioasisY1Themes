...
<body>
        ...
        <div id="lightbox-config-info" class="lightbox-config-info" onclick="event.stopPropagation()" style="display: none;">
            ...
            <div class="lightbox-config-details">
                <div class="lightbox-config-item">
                    <strong>Config Key:</strong> <code id="lightbox-config-key"></code>
                </div>
                <div class="lightbox-config-item">
    ...
    <script>
        ...
        // Lightbox functions
        function openLightbox(imgSrc, configKey = null, imageName = null) {
            ...
            const configKeyEl = document.getElementById('lightbox-config-key');
            ...
            if (configKey && imageName) {
                configKeyEl.textContent = configKey;
        ...
        async function loadThemeImages() {
            ...
            try {
                ...
                if (configImageEntries.length === 0) {
                    // Hide the entire carousel section if no images found
                ...
                if (loadedImageData.length === 0) {
                    // Hide the entire carousel section if no images loaded
                    const carouselSection = document.getElementById('image-carousel-section');
                    if (carouselSection) {
                        carouselSection.style.display = 'none';
                    }
                ...
                // Show the carousel section now that we have images
                const carouselSection = document.getElementById('image-carousel-section');
                if (carouselSection) {
